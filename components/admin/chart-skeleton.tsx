...
export function ChartSkeleton() {
  return (
    <div className="space-y-6">
      ...
      {/* Chart Area */}
      <div className="h-[400px] rounded-xl bg-gray-100 border border-gray-300">
        {/* Simulate chart lines */}
        <div className="p-6 h-full flex items-end gap-2">
          {[45, 60, 30, 70, 50, 85, 40, 65, 55, 75, 35, 60].map((height, i) => (
            <div
              key={i}
              className="flex-1 bg-linear-to-t from-gray-200 to-gray-300 rounded-t-lg animate-pulse"
              style={{
                height: `${height}%`,
...
export function DoughnutSkeleton() {
  return (
    <div className="h-[400px] flex items-center justify-center animate-pulse">
      <div className="w-64 h-64 rounded-full bg-gray-200 border border-gray-300" />
    </div>
  );
}
